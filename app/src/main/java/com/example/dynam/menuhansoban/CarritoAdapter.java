...
public class CarritoAdapter extends BaseAdapter {
     ...
     *****************/
    public CarritoAdapter(Activity a, ArrayList d, Resources resLocal) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
           ...
           // holder.item_text3 = (TextView) vi.findViewById(R.id.description2);
            ...
            holder.image = (ImageView) vi.findViewById(R.id.foto_carrito);
    ...
    public void carro (View anchorView, int position, ViewHolder holder){
        ...
        CarritoAdapter adapter= new CarritoAdapter(activity,app.getArray(),res);
