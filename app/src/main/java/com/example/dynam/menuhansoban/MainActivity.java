        ...
        public void onClick(final View v) {
            ...
            switch (v.getId()) {
                case R.id.imageButton:
                    intent = new Intent(MainActivity.this, MenuActivity.class).putExtra("categoria", "blanc");
                    startActivity(intent);
                    break;
                case R.id.imageButton2:
                    //intent = new Intent(MainActivity.this, CategoriaActivity.class).putExtra("categoria", R.layout.content_categoria);
                    intent = new Intent(MainActivity.this, MenuActivity.class).putExtra("categoria", "almuerzo");
                    startActivity(intent);
                    break;
