...
//		mNotificationManager.notify(notifyID, mNotifyBuilder.build());
	...
	public void syncSQLiteMySQLDB() {
		...
		client.post("http://192.168.1.38:8080/mysqlsqlitesync2/getusers.php", params, new AsyncHttpResponseHandler() {
			@Override
		...
		try {
			...
			if (arr.length() != 0) {
				...
				for (int i = 0; i < arr.length(); i++) {
					...
					queryValues.put("korean", obj.get("korean").toString());
					System.out.println(obj.get("korean").toString());
					...
					// Add description2 extracted from Object
					queryValues.put("picante", obj.get("picante").toString());
					// Add description2 extracted from Object
					queryValues.put("koreancat", obj.get("koreancat").toString());
	...
	public void updateMySQLSyncSts(String json) {
		...
		client.post("http://192.168.1.38:8080/mysqlsqlitesync2/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
			@Override
			public void onSuccess(String response) {
