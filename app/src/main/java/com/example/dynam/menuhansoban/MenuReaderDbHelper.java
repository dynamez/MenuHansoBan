...
public class MenuReaderDbHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "hansoban ";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query;
        query = "CREATE TABLE IF NOT EXISTS menu ( id INTEGER, name TEXT, korean TEXT, description TEXT, price DOUBLE, category TEXT, picante TEXT, koreancat TEXT,foto2 TEXT)";
        db.execSQL(query);
    ...
    public void createDatabase(){
       ...
       // }else{
            ...
            //db.execSQL("INSERT INTO " + TABLE_MENU + "(id,name,korean,description,description2,price,category,picante,foto2)"+
              //     " Values ('0','Bugeot guk','북어 국','Sopa de merluza deshidratada con verduras','Sopa de merluza deshidratada con verduras'" +
                //   ",'6000','almuerzo','0','magurot');");
...
//    }
    ...
    public void insertUser(HashMap<String, String> queryValues) {
        ...
        values.put("korean", queryValues.get("korean"));
        ...
        values.put("picante", queryValues.get("picante"));
        values.put("koreancat", queryValues.get("koreancat"));
    ...
    public ArrayList<MenuTemple> getAllBooks(String categoria) {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                menu.setName(cursor.getString(1));
                menu.setKorean(cursor.getString(2));
                System.out.println(cursor.getString(2));
                menu.setDescription(cursor.getString(3));
                menu.setPrice(cursor.getDouble(4));
                menu.setCategory(cursor.getString(5));
                menu.setPicante(cursor.getString(6));
                menu.setKoreancat(cursor.getString(7));
                System.out.println(cursor.getInt(7));
                menu.setFoto2(cursor.getString(8));
    ...
    public ArrayList<MenuTemple> getMenubyID(Integer id) {
        ArrayList<MenuTemple> menus = new ArrayList<MenuTemple>();
        System.out.println(id+" id en getmenu");
        // 1. build the query
